...
# Luisterknop bovenaan als er iets geselecteerd is
...
# Hoofdlayout: Kaart links (70%), Tabel rechts (30%)
main_col1, main_col2 = st.columns([7, 3])

# --- 1. KAART VOORBEREIDEN ---
...
# Hoogte instellen zodat het mooi naast de tabel past
fig.update_layout(coloraxis_showscale=False, margin={"r":0,"t":0,"l":0,"b":0}, height=650)
...
gb.configure_column("Naam", minWidth=150)
gb.configure_column("Aflevering", minWidth=100)
...
# Teken tabel in de rechter kolom
with main_col2:
    grid_response = AgGrid(
        ...
        theme='streamlit',
        height=650 # Zelfde hoogte als de kaart
    )

# --- 3. LOGICA VOOR INTERACTIE ---
# Verwerk kaart-klik
